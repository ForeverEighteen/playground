...
bind r source-file /usr/share/byobu/profiles/tmuxrc \; display-message "ZXF is a PIG!!!"
# v2.3 or below
...
set -g status-left '#[bg=colour247]#[fg=colour0]#{?client_prefix,#[bg=colour24]#[fg=colour249],} Valentina #S #[bg=default]#[fg=colour247]#{?client_prefix,#[fg=colour24],}#{?window_zoomed_flag, ,}#[fg=colour99]#[bg=default] ♂ #(~/dotfiles/tmux_scripts/battery.sh)'
